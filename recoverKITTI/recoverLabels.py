...
root_dir = '/home/donceykong/kitti_360/kitti360Scripts/data/KITTI-360'
seq_list = [9, 10]
for seq in seq_list:
    if seq == (1 or 8):
        continue
    sequence = '2013_05_28_drive_%04d_sync' % seq
    output_dir = f'/home/donceykong/kitti_360/kitti360Scripts/data/KITTI360/data_3d_semantics/train/{sequence}/labels'

    print(f"Looking at sequence {seq}")
...
# parser.add_argument("-o", "--output_dir", default='/home/donceykong/kitti_360/kitti360Scripts/data/KITTI360/data_3d_semantics/train/2013_05_28_drive_0002_sync/labels', help="path to output_dir")
# parser.add_argument("-s", "--sequence", default='2013_05_28_drive_0002_sync', help="sequence name")
